...
CREATE TABLE `ui_chromie_time_expansion_info` (
  ...
  `MapAtlasElement` int(11) NOT NULL DEFAULT '0',
  `PreviewAtlasElement` int(11) NOT NULL DEFAULT '0',
  `ShowPlayerConditionID` int(11) NOT NULL DEFAULT '0',
  `ExpansionMask` int(11) NOT NULL DEFAULT '0',
  `ContentTuningID` int(11) NOT NULL DEFAULT '0',
  `CompletedPlayerConditionID` int(11) NOT NULL DEFAULT '0',
  `SortPriority` int(11) NOT NULL DEFAULT '0',
  `RecommendPlayerConditionID` int(11) NOT NULL DEFAULT '0',
