    ...
    public:
        ...
        struct instance_aberrus_the_shadowed_crucible_InstanceMapScript: public InstanceScript
        {
            ...
            uint32 GetData(uint32 type) const override
            {
                switch (type)
                {
                    case DATA_KAZZARA_INTRO:
                        return IsKazzaraIntroDone ? 1 : 0;
                    default:
                        break;
                }
            ...
            void SetData(uint32 type, uint32 data) override
            {
                ...
                {
                    case DATA_KAZZARA_INTRO:
                        IsKazzaraIntroDone = data ? true : false;
                        if (IsKazzaraIntroDone)
                            instance->SpawnGroupDespawn(2000, true);
                        break;
                    default:
                        break;
                }
