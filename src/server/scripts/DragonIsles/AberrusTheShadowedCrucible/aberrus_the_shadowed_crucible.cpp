            ...
            switch (_events.ExecuteEvent())
            {
                case EVENT_KAZZARA_INTRO:
                {
                    ...
                    for (uint8 i = 0; i < 6; i++)
                    {
                        ...
                        zskarn->ToCreature()->DespawnOrUnsummon(45s);                        
                    }

                    _events.ScheduleEvent(EVENT_KAZZARA_INTRO_DONE, Seconds(45));
                    break;
                }
                case EVENT_KAZZARA_INTRO_DONE:
                {
                    conversation->GetInstanceScript()->SetData(DATA_KAZZARA_INTRO, 1);
                    break;
                }
                default:
                    break;
