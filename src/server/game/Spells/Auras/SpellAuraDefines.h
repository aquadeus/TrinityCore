...
enum AuraType : uint32
{
    ...
    SPELL_AURA_PET_DAMAGE_MULTI                             = 157, // NYI
    ...
    SPELL_AURA_MOD_VISIBILITY_RANGE                         = 225, // NYI
    ...
    SPELL_AURA_237                                          = 237, // NYI
    SPELL_AURA_238                                          = 238, // NYI
    ...
    SPELL_AURA_MOD_TARGET_RESIST_BY_SPELL_CLASS             = 257, // NYI
    ...
    SPELL_AURA_DETECT_AZERITE                               = 265, // NYI
    ...
    SPELL_AURA_320                                          = 320, // NYI
    SPELL_AURA_MOD_NO_ACTIONS                               = 321,
    SPELL_AURA_INTERFERE_TARGETTING                         = 322,
    SPELL_AURA_323                                          = 323, // NYI
    SPELL_AURA_OVERRIDE_UNLOCKED_AZERITE_ESSENCE_RANK       = 324, // NYI
    ...
    SPELL_AURA_ENABLE_BOSS1_UNIT_FRAME                      = 357, // NYI
    SPELL_AURA_WORGEN_ALTERED_FORM                          = 358, // NYI
    SPELL_AURA_MOD_HEALING_DONE_VERSUS_AURASTATE            = 359,
    SPELL_AURA_PROC_TRIGGER_SPELL_COPY                      = 360, // NYI
    SPELL_AURA_OVERRIDE_AUTOATTACK_WITH_MELEE_SPELL         = 361,
    SPELL_AURA_362                                          = 362, // NYI
    SPELL_AURA_MOD_NEXT_SPELL                               = 363, // NYI
    SPELL_AURA_364                                          = 364,
    SPELL_AURA_MAX_FAR_CLIP_PLANE                           = 365, // NYI
    SPELL_AURA_OVERRIDE_SPELL_POWER_BY_AP_PCT               = 366,
    SPELL_AURA_OVERRIDE_AUTOATTACK_WITH_RANGED_SPELL        = 367, // NYI
    SPELL_AURA_368                                          = 368, // NYI
    SPELL_AURA_ENABLE_POWER_BAR_TIMER                       = 369, // NYI
    SPELL_AURA_SPELL_OVERRIDE_NAME_GROUP                    = 370, // NYI
    SPELL_AURA_371                                          = 371,
