...
void Manager::SendVignetteUpdateToClient()
{
    ...
    for (auto x : _removedVignette)
        packet.RemovedCount.IDs.emplace_back(x);
    ...
    for (auto v : _updatedVignette)
    {
        ...
        packet.UpdatedCount.Data.emplace_back(vignette->GetGuid(), vignette->GetPosition(), vignette->GetVignetteEntry()->ID, vignette->GetZoneID());
        packet.UpdatedCount.IdList.IDs.emplace_back(v);
    }
    ...
    for (auto v : _addedVignette)
    {
        ...
        auto vignette = x->second;
        packet.AddedCount.Data.emplace_back(vignette->GetGuid(), vignette->GetPosition(), vignette->GetVignetteEntry()->ID, vignette->GetZoneID());
        packet.AddedCount.IdList.IDs.emplace_back(v);
    }
