...
CREATE TABLE `area_poi` (
  ...
  `Unknown910_11` int unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `broadcast_text_duration`
--

LOCK TABLES `broadcast_text_duration` WRITE;
/*!40000 ALTER TABLE `broadcast_text_duration` DISABLE KEYS */;
/*!40000 ALTER TABLE `broadcast_text_duration` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `challenge_mode_item_bonus_override`
--

LOCK TABLES `challenge_mode_item_bonus_override` WRITE;
/*!40000 ALTER TABLE `challenge_mode_item_bonus_override` DISABLE KEYS */;
/*!40000 ALTER TABLE `challenge_mode_item_bonus_override` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `char_base_info`
--

LOCK TABLES `char_base_info` WRITE;
/*!40000 ALTER TABLE `char_base_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `char_base_info` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `chr_classes` (
  ...
  `RoleInfoString` text,
  `DisabledString` text,
  `HyphenatedNameMale` text,
  `HyphenatedNameFemale` text,
  `ID` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `chr_classes_locale` (
  ...
  `Description_lang` text,
  `RoleInfoString_lang` text,
  `DisabledString_lang` text,
  `HyphenatedNameMale_lang` text,
  `HyphenatedNameFemale_lang` text,
  `VerifiedBuild` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
/*!50500 PARTITION BY LIST  COLUMNS(locale)
...
--
-- Dumping data for table `content_tuning_x_label`
--

LOCK TABLES `content_tuning_x_label` WRITE;
/*!40000 ALTER TABLE `content_tuning_x_label` DISABLE KEYS */;
/*!40000 ALTER TABLE `content_tuning_x_label` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `flight_capability`
--

LOCK TABLES `flight_capability` WRITE;
/*!40000 ALTER TABLE `flight_capability` DISABLE KEYS */;
/*!40000 ALTER TABLE `flight_capability` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `item_bonus_list_group_entry`
--

LOCK TABLES `item_bonus_list_group_entry` WRITE;
/*!40000 ALTER TABLE `item_bonus_list_group_entry` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_bonus_list_group_entry` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `item_bonus_tree`
--

LOCK TABLES `item_bonus_tree` WRITE;
/*!40000 ALTER TABLE `item_bonus_tree` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_bonus_tree` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `item_x_item_effect`
--

LOCK TABLES `item_x_item_effect` WRITE;
/*!40000 ALTER TABLE `item_x_item_effect` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_x_item_effect` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `maw_power`
--

LOCK TABLES `maw_power` WRITE;
/*!40000 ALTER TABLE `maw_power` DISABLE KEYS */;
/*!40000 ALTER TABLE `maw_power` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `quest_v2_cli_task` (
  ...
  `ContentTuningID` int NOT NULL DEFAULT '0',
  `CovenantID` int NOT NULL DEFAULT '0',
  `Unknown902_22` int NOT NULL DEFAULT '0',
  `Flags1` int NOT NULL DEFAULT '0',
  `Flags2` int NOT NULL DEFAULT '0',
  `Flags3` int NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `soulbind_conduit_rank`
--

LOCK TABLES `soulbind_conduit_rank` WRITE;
/*!40000 ALTER TABLE `soulbind_conduit_rank` DISABLE KEYS */;
/*!40000 ALTER TABLE `soulbind_conduit_rank` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `spell_empower`
--

LOCK TABLES `spell_empower` WRITE;
/*!40000 ALTER TABLE `spell_empower` DISABLE KEYS */;
/*!40000 ALTER TABLE `spell_empower` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `spell_empower_stage`
--

LOCK TABLES `spell_empower_stage` WRITE;
/*!40000 ALTER TABLE `spell_empower_stage` DISABLE KEYS */;
/*!40000 ALTER TABLE `spell_empower_stage` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `trait_sub_tree`
--

LOCK TABLES `trait_sub_tree` WRITE;
/*!40000 ALTER TABLE `trait_sub_tree` DISABLE KEYS */;
/*!40000 ALTER TABLE `trait_sub_tree` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `trait_sub_tree_locale`
--

LOCK TABLES `trait_sub_tree_locale` WRITE;
/*!40000 ALTER TABLE `trait_sub_tree_locale` DISABLE KEYS */;
/*!40000 ALTER TABLE `trait_sub_tree_locale` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `ui_splash_screen`
--

LOCK TABLES `ui_splash_screen` WRITE;
/*!40000 ALTER TABLE `ui_splash_screen` DISABLE KEYS */;
/*!40000 ALTER TABLE `ui_splash_screen` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `ui_splash_screen_locale`
--

LOCK TABLES `ui_splash_screen_locale` WRITE;
/*!40000 ALTER TABLE `ui_splash_screen_locale` DISABLE KEYS */;
/*!40000 ALTER TABLE `ui_splash_screen_locale` ENABLE KEYS */;
UNLOCK TABLES;
