...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_DEL_ALL_CHAR_QUESTSTATUS_BY_QUEST,
    CHAR_REP_CHAR_QUESTSTATUS_OBJECTIVES,
    CHAR_DEL_CHAR_QUESTSTATUS_OBJECTIVES_BY_QUEST,
    CHAR_DEL_ALL_CHAR_QUESTSTATUS_OBJECTIVES_BY_QUEST,
    ...
    CHAR_DEL_ALL_CHAR_QUESTSTATUS_REWARDED_BY_QUEST,
